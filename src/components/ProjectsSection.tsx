  ...
  return (
    <section id="projects" className="relative py-8 lg:py-20">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        {/* Header */}
        <div
          className={`flex flex-col lg:flex-row justify-between items-start mb-4 lg:mb-8 transform transition-all duration-1000 ${
        ...
        >
          ...
          <button className="hidden lg:flex text-gray-900 font-semibold items-center gap-2 hover:text-orange-400 transition-colors duration-300">
            More
